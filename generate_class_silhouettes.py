...
commoner_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <!-- Hair: Blonde -->
...
mage_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  {base_head}
  <!-- Eyes closed -->
  <rect x="44" y="44" width="12" height="4" fill="#3e2d26" />
  <rect x="72" y="44" width="12" height="4" fill="#3e2d26" />
...
priest_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <!-- Hair: soft gold -->
...
warrior_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  {base_head}
  <!-- Eyes closed -->
  <rect x="44" y="44" width="12" height="4" fill="#3e2d26" />
  <rect x="72" y="44" width="12" height="4" fill="#3e2d26" />
...
print("Generated 4 new character files in assets!")
