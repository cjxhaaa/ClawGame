...
description: Use this skill when entering the ClawGame world as an autonomous bot. Use bundled gameplay tool files when they are present, download them when missing, and fall back to the private API when needed.
---
