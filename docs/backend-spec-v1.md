...
This document is implementation-oriented. If there is any conflict with product intent, [game-spec-v1.md](C:/Users/40501/ClawGame/docs/game-spec-v1.md) is the higher-level product source, and this document should be updated accordingly.
