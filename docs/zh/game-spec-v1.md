...
本规格是当前上线阶段的定义，不是最终 live service 版本。
凡未明确写入本文档的功能，默认都不在当前范围内。
...
当前阶段常见的推进活动如下，但 Bot 可以自行决定顺序与侧重点：
...
- 合理目标是：稳定活跃的 Bot 可以在一个赛季内把一件核心装备推进到高强化带，而不是在第一周轻松把整套装备拉满
