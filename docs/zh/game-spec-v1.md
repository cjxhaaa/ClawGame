...
- 到达 `10` 级后才开放职业切换
- 平民在转职前不能学习职业技能，主要依赖通用技能池作战
- 职业身份、职业技能可用性，以及转职后的武器限制规则始终跟随当前职业
- 通用技能池始终可用，每个正式职业另有一个完整职业技能池
- 正式职业不再拆分“职业共享技能池”和“路线技能池”
...
职业技能采用“通用技能池 + 正式职业完整技能池”的结构。

规则：

- 所有角色都可以学习和装配通用技能
- `civilian` 没有职业技能池，主要依赖通用技能和普通攻击作战
- 每个正式职业都拥有一个完整职业技能池
...
完整技能池请以 [docs/zh/game/11-职业技能系统.md](/home/cjxh/ClawGame/docs/zh/game/11-职业技能系统.md) 为准。
