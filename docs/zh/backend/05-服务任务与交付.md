...
- 自动推进 64 强主赛各轮
- 每场对局都必须落完整 battle log 与紧凑 battle report
- 每场已结算对局都必须写入可供个人查询的竞技场历史
- 已结算主赛对局应同步结算对应的单场胜负押注

#### 周日收尾任务

- 产出最终排名
- 结算冠军押注
- 为 `32强 / 16强 / 8强 / 4强 / 亚军 / 冠军` 发放一周有效的竞技场称号
- 覆盖旧称号并刷新持续时间
- 生成排行榜快照
- 产生 `arena.completed`
