...
var skillDefinitions = map[string]skillDefinition{
	...
	"Bulwark Field":     {SkillID: "Bulwark Field", Name: "Bulwark Field", DisplayNameZH: "壁垒领域", Class: "warrior", RouteID: "tank", Track: "tank", Tier: "ultimate", CooldownRounds: 3},
	"Linebreaker":       {SkillID: "Linebreaker", Name: "Linebreaker", DisplayNameZH: "裂阵斩", Class: "warrior", RouteID: "tank", Track: "tank", Tier: "advanced", CooldownRounds: 2},
	...
	"Execution Rush":    {SkillID: "Execution Rush", Name: "Execution Rush", DisplayNameZH: "处决突进", Class: "warrior", RouteID: "physical_burst", Track: "physical_burst", Tier: "ultimate", CooldownRounds: 3},
	...
	"Arc Veil":          {SkillID: "Arc Veil", Name: "Arc Veil", DisplayNameZH: "奥术帷幕", Class: "mage", RouteID: "control", Track: "control", Tier: "advanced", CooldownRounds: 2},
	"Focus Pulse":       {SkillID: "Focus Pulse", Name: "Focus Pulse", DisplayNameZH: "聚能脉冲", Class: "mage", RouteID: "single_burst", Track: "single_burst", Tier: "normal", CooldownRounds: 1},
	"Disrupt Ray":       {SkillID: "Disrupt Ray", Name: "Disrupt Ray", DisplayNameZH: "扰乱射线", Class: "mage", RouteID: "control", Track: "control", Tier: "advanced", CooldownRounds: 2},
	...
	"Detonate Sigil":    {SkillID: "Detonate Sigil", Name: "Detonate Sigil", DisplayNameZH: "引爆秘印", Class: "mage", RouteID: "single_burst", Track: "single_burst", Tier: "ultimate", CooldownRounds: 3},
	"Star Pierce":       {SkillID: "Star Pierce", Name: "Star Pierce", DisplayNameZH: "星芒穿刺", Class: "mage", RouteID: "single_burst", Track: "single_burst", Tier: "advanced", CooldownRounds: 2},
	"Flame Burst":       {SkillID: "Flame Burst", Name: "Flame Burst", DisplayNameZH: "烈焰爆裂", Class: "mage", RouteID: "aoe_burst", Track: "aoe_burst", Tier: "advanced", CooldownRounds: 2},
	"Meteor Shard":      {SkillID: "Meteor Shard", Name: "Meteor Shard", DisplayNameZH: "陨星碎片", Class: "mage", RouteID: "aoe_burst", Track: "aoe_burst", Tier: "ultimate", CooldownRounds: 3},
	...
	"Restore":           {SkillID: "Restore", Name: "Restore", DisplayNameZH: "恢复术", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "normal", CooldownRounds: 1},
	"Sanctuary Mark":    {SkillID: "Sanctuary Mark", Name: "Sanctuary Mark", DisplayNameZH: "圣护印记", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "advanced", CooldownRounds: 2},
	"Purge":             {SkillID: "Purge", Name: "Purge", DisplayNameZH: "净除", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "normal", CooldownRounds: 1},
	"Grace Field":       {SkillID: "Grace Field", Name: "Grace Field", DisplayNameZH: "恩泽领域", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "advanced", CooldownRounds: 2},
	"Purifying Wave":    {SkillID: "Purifying Wave", Name: "Purifying Wave", DisplayNameZH: "净化之潮", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "ultimate", CooldownRounds: 3},
	"Prayer of Renewal": {SkillID: "Prayer of Renewal", Name: "Prayer of Renewal", DisplayNameZH: "复苏祷言", Class: "priest", RouteID: "healing_support", Track: "healing_support", Tier: "ultimate", CooldownRounds: 3},
	...
	"Judged Weakness":   {SkillID: "Judged Weakness", Name: "Judged Weakness", DisplayNameZH: "弱点审判", Class: "priest", RouteID: "curse", Track: "curse", Tier: "advanced", CooldownRounds: 2},
	...
	"Wither Prayer":     {SkillID: "Wither Prayer", Name: "Wither Prayer", DisplayNameZH: "枯败祷言", Class: "priest", RouteID: "curse", Track: "curse", Tier: "ultimate", CooldownRounds: 3},
