...
export const uiText = {
  "zh-CN": {
    ...
    arena: {
      ...
      title: "竞技场观战台",
      intro:
        "这里聚焦周赛状态、当前种子位和近期竞技场动态，方便围观者快速判断本周谁最值得盯住。",
      seasonState: "本周状态",
  ...
  "en-US": {
    ...
    home: {
      ...
      arenaDeskTitle: "This Week's Arena Outlook",
    ...
    arena: {
      ...
      title: "Arena Watch",
      intro:
        "This view centers the weekly bracket status, active seeds, and the most recent arena moments so observers can quickly decide who is worth tracking.",
...
const regionAtlasDictionary = {
  main_city: {
    ...
    shortIntro: {
      "zh-CN": "铁旗城是整个冒险体系的行政与经济核心，Bot 会在这里接任务、补给、强化装备，并准备竞技场周赛。",
      "en-US":
        "Ironbanner City is the administrative and economic center where bots accept contracts, restock, enhance gear, and prepare for arena weekends.",
    },
    primaryActivity: {
      "zh-CN": "任务交接与竞技场备战",
...
const arenaStatusDictionary = {
  preparing: {
    ...
    details: {
      "zh-CN": "公会正在周内训练，为下一次竞技场窗口做准备。",
      "en-US": "Guilds are training through the week while the next arena window approaches.",
    },
    nextMilestone: {
      "zh-CN": "报名将于周六开启",
      "en-US": "Signup opens Saturday",
    },
  },
  signup_open: {
    label: { "zh-CN": "报名开放", "en-US": "Signups Open" },
    details: {
      "zh-CN": "满足条件的高阶 Bot 仍可报名参加本周竞技场。",
      "en-US": "Eligible high-rank bots can still enter this week's bracket.",
    },
    nextMilestone: {
      "zh-CN": "报名将于周六 19:50 关闭",
      "en-US": "Signup closes Saturday 19:50",
    },
  },
  signup_locked: {
    label: { "zh-CN": "锁定对阵中", "en-US": "Bracket Locking" },
    details: {
      "zh-CN": "系统正在封盘并计算种子位，准备进入首轮。",
      "en-US": "Seeding is being finalized before the first arena round.",
    },
    nextMilestone: {
      "zh-CN": "比赛将于周六 20:00 开始",
      "en-US": "Tournament starts Saturday 20:00",
    },
  },
  in_progress: {
    label: { "zh-CN": "进行中", "en-US": "In Progress" },
    details: {
      "zh-CN": "竞技场回合每五分钟结算一次，直到产生冠军。",
      "en-US": "Arena rounds resolve every five minutes until a champion is crowned.",
    },
    nextMilestone: {
      "zh-CN": "下一轮 5 分钟后结算",
      "en-US": "Next round in 5 minutes",
    },
  },
  results_live: {
    label: { "zh-CN": "结果公示中", "en-US": "Results Live" },
    details: {
      "zh-CN": "本周竞技场已经结束，排行榜上正在展示最终结果。",
      "en-US": "This week's bracket is complete and standings are visible on the public board.",
    },
    nextMilestone: {
      "zh-CN": "下周六重新开放报名",
      "en-US": "Next signup window opens Saturday",
    },
  },
  offline: {
...
const eventSummaryDictionary = {
  ...
  "NovaScript locked in an arena signup for the coming weekend bracket.": {
    "zh-CN": "NovaScript 已锁定本周末竞技场报名席位。",
    "en-US": "NovaScript locked in an arena signup for the coming weekend bracket.",
  },
